...
<?php
	...
	*/
	...
	add_shortcode('cgsms','_cgsms_shortcode_iframe' );
	/*
	...
	add_shortcode('cheapglobalsms', $shortcode_fn);
	add_shortcode('cgsms', $shortcode_fn);
	*/